...
/* 3. Выберите, что должен сделать текущий поток: дождаться или отсоединиться 
 * 
 ...
 */	
	...
	//-----------------------------
	/*
	 * Основной проблемой не отсоединенных потоков в том, что необходимо, чтобы между созданием потока
